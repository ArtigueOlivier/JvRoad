 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class JrActionEditionAddBook extends JrActionMenu {
	public JrActionEditionAddBook() {
		super("MenuEditAddBook",KeyEvent.VK_J,"MenuEditAddBookHlp");
	}
	/* (non-Javadoc)
