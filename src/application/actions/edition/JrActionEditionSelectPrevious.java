 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class JrActionEditionSelectPrevious extends JrActionMenu {
	public JrActionEditionSelectPrevious() {
		super("MenuEditSelectPrevious",KeyEvent.VK_R,KeyEvent.VK_LEFT,
				ActionEvent.CTRL_MASK,"MenuEditSelectPrevious");
	}
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (map.selectPreviousObjectName(cnt))
